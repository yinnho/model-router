...
This directory contains the Flatpak manifest (`com.modelrouter.desktop`) for Model Router, used to convert the generated `.deb` artifact into an installable `.flatpak` package via CI or local builds.

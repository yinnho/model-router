...
Model Router v3.7.0 introduces six major features with over 18,000 lines of new code.
...
- **Deep link integration** - Import via `modelrouter://` protocol
...
v3.7.0 represents a shift in Model Router's positioning:
...
Visit [Releases](https://github.com/yinnho/model-router/releases/latest) to download:

- **Windows**: `Model-Router-v3.7.0-Windows.msi` or `-Portable.zip`
- **macOS**: `Model-Router-v3.7.0-macOS.tar.gz` or `.zip`
- **Linux**: `Model-Router-v3.7.0-Linux.AppImage` or `.deb`
...
- [@yinnho](https://github.com/farion1231) - From developer to issue responder
...
- **Issues**: [GitHub Issues](https://github.com/yinnho/model-router/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yinnho/model-router/discussions)

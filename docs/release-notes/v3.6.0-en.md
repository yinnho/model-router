...
**[中文更新说明 Chinese Documentation →](https://github.com/yinnho/model-router/blob/main/docs/release-notes/v3.6.0-zh.md)**
...
- Download `Model-Router-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `Model-Router-v3.6.0-Windows.msi`
- **Portable**: `Model-Router-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `Model-Router-v3.6.0-Linux.AppImage`
- **Debian**: `Model-Router-v3.6.0-Linux.deb`
...
**Full Changelog**: https://github.com/yinnho/model-router/compare/v3.5.1...v3.6.0

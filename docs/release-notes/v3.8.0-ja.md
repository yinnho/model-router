...
Model Router v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/yinnho/model-router/releases/latest) から入手:

- **Windows**: `Model-Router-v3.8.0-Windows.msi` または `-Portable.zip`
- **macOS**: `Model-Router-v3.8.0-macOS.tar.gz` または `.zip`
- **Linux**: `Model-Router-v3.8.0-Linux.AppImage` または `.deb`
...
- [@yinnho](https://github.com/farion1231) - バグ修正と機能拡張
...
- **Issue**: [GitHub Issues](https://github.com/yinnho/model-router/issues)

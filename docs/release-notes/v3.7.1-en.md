...
Visit [Releases](https://github.com/yinnho/model-router/releases/latest) to download the latest version
...
- **Windows**: `Model-Router-Windows.msi` or `-Portable.zip`
- **macOS**: `Model-Router-macOS.tar.gz` or `.zip`
- **Linux**: `Model-Router-Linux.AppImage` or `.deb`

...
Model Router v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
- **Windows**: `Model-Router-v3.8.0-Windows.msi` or `-Portable.zip`
- **macOS**: `Model-Router-v3.8.0-macOS.tar.gz` or `.zip`
- **Linux**: `Model-Router-v3.8.0-Linux.AppImage` or `.deb`
...
- [@yinnho](https://github.com/farion1231) - Bug fixes and feature enhancements
...
- **Issue Reports**: [GitHub Issues](https://github.com/yinnho/model-router/issues)

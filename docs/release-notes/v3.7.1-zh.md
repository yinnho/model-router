...
访问 [Releases](https://github.com/yinnho/model-router/releases/latest) 下载最新版本
...
访问 [Releases](https://github.com/yinnho/model-router/releases/latest) 下载：

- **Windows**：`Model-Router-Windows.msi` 或 `-Portable.zip`
- **macOS**：`Model-Router-macOS.tar.gz` 或 `.zip`
- **Linux**：`Model-Router-Linux.AppImage` 或 `.deb`
...
- [@yinnho](https://github.com/farion1231) - 从开发沦为 issue 回复机
- 社区成员的测试和反馈
...
- **问题反馈**：[GitHub Issues](https://github.com/yinnho/model-router/issues)
- **讨论**：[GitHub Discussions](https://github.com/yinnho/model-router/discussions)

...
**[中文更新说明 Chinese Documentation →](https://github.com/yinnho/model-router/blob/main/docs/release-notes/v3.6.1-zh.md)**
...
- Download `Model-Router-v3.6.1-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `Model-Router-v3.6.1-Windows.msi`
- **Portable**: `Model-Router-v3.6.1-Windows-Portable.zip`

#### Linux

- **AppImage**: `Model-Router-v3.6.1-Linux.AppImage`
- **Debian**: `Model-Router-v3.6.1-Linux.deb`

---

### 📚 Documentation

- [中文文档 (Chinese)](https://github.com/yinnho/model-router/blob/main/README_ZH.md)
- [English Documentation](https://github.com/yinnho/model-router/blob/main/README.md)
- [完整更新日志 (Full Changelog)](https://github.com/yinnho/model-router/blob/main/CHANGELOG.md)
...
**Full Changelog**: https://github.com/yinnho/model-router/compare/v3.6.0...v3.6.1
...
- **Customizable Storage Location** - Customize Model Router's configuration storage directory
...
Model Router is a cross-platform desktop application for managing and switching between different provider configurations for Claude Code and Codex. Built with Tauri 2.0 + React 18 + TypeScript, supporting Windows, macOS, and Linux.
...
**Project Repository**: https://github.com/yinnho/model-router

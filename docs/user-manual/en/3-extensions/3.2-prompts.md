...
Model Router provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
modelrouter://import/prompt?data=<base64-encoded preset>
```

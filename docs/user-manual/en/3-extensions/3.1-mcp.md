...
When enabling an app's toggle, Model Router will:
...
When disabling an app's toggle, Model Router will:
...
If you have already configured MCP servers in CLI tools, you can import them into Model Router:

1. Click the "Import" button
2. Select the app to import from (Claude/Codex/Gemini/OpenCode)
3. Model Router reads the existing configuration and imports it

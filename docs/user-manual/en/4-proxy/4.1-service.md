...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (Model Router)
...
After starting the proxy and enabling app takeover, Model Router modifies app configurations:
...
When stopping the proxy, Model Router will:

...
| File | Description |
|------|-------------|
| [5.1-config-files.md](./5-faq/5.1-config-files.md) | Model Router storage, CLI configuration file formats |
...
- Applicable to Model Router v3.15.0+
...
- [GitHub Issues](https://github.com/yinnho/model-router/issues)
- [GitHub Repository](https://github.com/yinnho/model-router)

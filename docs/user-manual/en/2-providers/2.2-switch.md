...
2. Model Router updates the configuration file
...
1. Right-click the Model Router icon in the system tray
...
When switching providers, Model Router modifies the following files:

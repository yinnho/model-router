...
Model Router provides rich icon customization features:
...
This ensures Model Router and CLI tool configurations stay in sync.
...
When adding a provider, Model Router automatically extracts endpoint URLs from the configuration.

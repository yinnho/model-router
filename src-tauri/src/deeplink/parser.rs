...
//!
//! Parses modelrouter:// URLs into DeepLinkImportRequest structures.
...
/// Parse a modelrouter:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// modelrouter://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "modelrouter" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'modelrouter', got '{scheme}'"
        )));
    }

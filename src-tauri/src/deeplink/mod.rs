//! Deep link import functionality for Model Router
//!
//! This module implements the modelrouter:// protocol for importing configurations
...
///
/// Represents a parsed modelrouter:// URL ready for processing.

...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement by opening an issue at **https://github.com/yinnho/model-router/issues**. All complaints will be reviewed and investigated promptly and fairly.
...
辱骂、骚扰或其他不可接受的行为可通过在 **https://github.com/yinnho/model-router/issues** 提交 Issue 向负责监督的社区领袖报告。所有投诉都将得到及时和公平的审查和调查。
